...
public class AddDevice extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<DeviceImport> type = dvd.getAllDeviceType();
        request.setAttribute("type", type);
        request.getRequestDispatcher("addDv.jsp").forward(request, response);
    } 
    ...
    throws ServletException, IOException {
        ...
        dvd.insertDevice(code, type, price, descript, img);
