        ...
        <div class = "body">
            <div class = "uName">Tài Khoản: <span class = "rd">${sessionScope.account.getUserName()}<span></div>
                        ...
                        <script type = "text/javascript">
                            ...
                            console.log(Number(document.getElementById("numF").value));
                            if (Number(document.getElementById("numF").value) !== null)
                            ...
                            if (Number(document.getElementById("numT").value) !== null)
