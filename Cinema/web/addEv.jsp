    ...
    <body>
        ...
        <div class = "body">
            ...
            <div class = "detail">
                ...
                <form id ="frm" action = "addev" method = "post">
                    <div class = "event">
                        ...
                        <div class = "in4">
                            ...
                            <c:if test = "${requestScope.e != null}">
                                <div class = "prt">
                                    <span class = "blk">Mã ưu đãi:</span> ${requestScope.e.getEventCode()}
                                </div>
                            </c:if>
                            <c:if test = "${requestScope.e == null}">
                                <div class = "blk">
                                    <span class = "blk">Mã ưu đãi:</span> <input required class ="lko" type ="text" name ="ID"/>
                                </div>
                            </c:if>
                            <div class = "prt">
                            ...
                            <div class = "prt">
                                <div class = "blk">4. Kiểu ưu đãi:</div>
                                <div class = "plI">
                                    <div class = "m1">
                                ...
                                <c:if test = "${requestScope.f == null}">
                                    <div class = "m1">
                                        <div class = "pin4">
                                            ...
                                            <div class = "oIN4">
                                                ...
                                                <div>
                                                    Mã sản phẩm tặng kèm: 
                                                    <select name ="fCode" id = "fCode" disabled="true" required="false">
                                                        <c:forEach items = "${requestScope.allF}" var = "k">
                                                            <option value ="${k.getProductCode()}">${k.getProductCode()}</option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    <div class = "m1">
                                        Số ngày tối đa có thể đổi quà: <input type ="number" disabled="true" required="false" id ="dte" step ="1" min ="0" max ="7" name ="dte"/>
                                    </div>
                                </c:if>
                            ...
                            <div class = "prt">
                                <div class = "blk">5. Kiểu tác động:</div>
                                <div class = "plI">
                                    <div class = "m1">
                                ...
                                <c:if test = "${requestScope.movID == null}">
                                    <div class = "m1">
                                        <select id ="mov" required="true" name = "mov" >
                                            <c:forEach items = "${requestScope.mov}" var = "k">
                                                <option value = "${k.getMovID()}" ${k.getMovID() == movID?"selected":""}>${k.getMovName()}</option>
                                            </c:forEach>
                                        </select>
                            ...
                            <div class = "prt">
                                <div class = "blk">6. Điều kiện và điều khoản:</div>
                                <div class = "plI">
                                    <div class = "m1"> Áp dụng tại các rạp:
                                    </div>
                                    <div class ="imGe">
                            ...
                            <div class = "prt">
                                <div class = "blk">7. Ảnh:<input type = "text" required name = "img" value = "${requestScope.e.getImg()}"/></div> 

                            </div>


                            <div class = "prt">
                                <div class = "blk">8. Áp dụng với ưu đãi khác:
                                    <c:if test = "${requestScope.e != null}">
                                        <select name ="appO">
