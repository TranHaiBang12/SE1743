...
<html>
    ...
    <body>
                    ...
                    <div class = "frm">
                        ...
                        <div class = "insideForm">
                            ...
                            <c:if test = "${msNM == null}">
                                ...
                                <div class = "insideForm">
                                    <input type ="button" class ="sbMIT" value ="DELETE" onclick = "delT('${requestScope.id}', 'NM')"/>
                                </div>
                            </c:if>
                            <c:if test = "${msNM != null}">
                                <div class = "msTKET">
                                ...
                                <div class = "insideForm">
                                    <input type ="button" class ="sbMIT" value ="ADD" onclick = "addT('${requestScope.id}', 'NM')"/>
                                </div>
                            </c:if>
                        </div>
                        ...
                        <div class = "insideForm">
                            ...
                            <c:if test = "${msVP == null}">
                                ...
                                <div class = "insideForm">
                                    <input type ="button" class ="sbMIT" value ="DELETE" onclick = "delT('${requestScope.id}', 'VP')"/>
                                </div>
                            </c:if>
                            <c:if test = "${msVP != null}">
                                <div class = "msTKET">
                        ...
                        <div class = "insideForm">
                            ...
                            <c:if test = "${msVT == null}">
                                ...
                                <div class = "insideForm">
                                    <input type ="button" class ="sbMIT" value ="DELETE" onclick = "delT('${requestScope.id}', 'VT')"/>
                                </div>
                            </c:if>
                            <c:if test = "${msVT != null}">
                                <div class = "msTKET">
        ...
        <script type="text/javascript">
            function delT(id, type) {
                window.location = "dlttick?id=" + id + "&type=" + type;
            }
            
            function addT(id, type) {
                window.location = "addt?id=" + id + "&type=" + type;
            }
